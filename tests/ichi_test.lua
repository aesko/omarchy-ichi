...
check("parse defaults", cfg.defaults.width == 60 and cfg.defaults.height == 75 and cfg.defaults.step == 10)
...
check("json import wins over the line file", M.config.workspaces[3] and M.config.workspaces[3].mode == "aspect"
  and M.config.workspaces[2] == nil and M.config.defaults.step == 10)
